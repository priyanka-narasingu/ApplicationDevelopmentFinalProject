<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true"
    CodeBehind="RepStationeryRequistion.aspx.cs" Inherits="PresentationLayer.DeptRep.RepStationeryRequistion" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="dgvRequests" DataKeyNames="key" CssClass="table" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Quantity">
                                <ItemTemplate>
                                    <span class="form-group"><span class="col-sm-11" style="padding-right: 0px;">
                                        <asp:TextBox CssClass="form-control" ID="txtQty" runat="server" Text='<%# Eval("Quantity") %>'></asp:TextBox>
                            ...
                            <asp:CommandField DeleteText="Remove" ShowDeleteButton="True" ControlStyle-ForeColor="OrangeRed">
